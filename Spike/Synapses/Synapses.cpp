        ...
        case CONNECTIVITY_TYPE_GAUSSIAN_SAMPLE:
          {
            ...
            int max_number_of_new_synapses = number_of_new_synapses_per_postsynaptic_neuron * number_of_postsynaptic_neurons_in_group;
            // this->increment_number_of_synapses(max_number_of_new_synapses);
