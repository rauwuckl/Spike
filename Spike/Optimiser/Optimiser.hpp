...
public:
	...
	Optimiser(SpikingModel* spiking_model_parameter, string full_output_directory_parameter);

	SpikingModel * spiking_model = nullptr;
	string full_output_directory;
	...
	void write_optimisation_stage_parameters_to_file(int optimisation_stage);
